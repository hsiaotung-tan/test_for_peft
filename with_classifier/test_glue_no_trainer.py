...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default=None, help="Where to store the log files.")
...
def main():
    ...
    if args.task_name is not None:
        ...
        is_regression = datasets["test"].features["label"].dtype in ["float32", "float64"]
        if is_regression:
            num_labels = 1
        else:
